...
<div style="display: flex; justify-content: center; gap: 10px;">
    <img src="inst/screenshots/documentation_md.PNG" style="width: 45%;" alt="Documentation Markdown">
    <img src="inst/screenshots/documentation_html.PNG" style="width: 45%;" alt="Documentation HTML">
</div>
